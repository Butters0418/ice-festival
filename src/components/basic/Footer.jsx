...
import { footerBg } from '../../assets/layout';
function Footer({ hasLeftNav }) {
  return (
    <footer
      className="relative z-10 bg-white bg-cover bg-center"
      style={{ backgroundImage: `url(${footerBg})` }}
    >
      {/* 上 宣告 */}
      <div className="relative z-20   px-2 py-5 text-[#069FE7] sm:px-5 sm:py-8 lg:p-14">
          ...
          <div className="flex flex-col items-center justify-between px-3 lg:flex-row">
            <ul className="mb-5 hidden items-center justify-center md:flex lg:mb-0">
              <li className="flex items-center justify-center">
                追蹤我們
                <img src={footerArrow} className="ml-2" alt="arrow right" />
              </li>
              <li className="mx-2">
